...
(function ($, Drupal, drupalSettings) {
  ...
  function doSlickLightbox(i, elm) {
    ...
    var itemSelector = '[data-slick-lightbox-trigger]';
  ...
  Drupal.behaviors.slickLightbox = {
    attach: function (context) {
      $('[data-slick-lightbox-gallery]:not(.slick-lightbox-gallery--on)', context).once('slick-lightbox-gallery').each(doSlickLightbox);
    }
  };
